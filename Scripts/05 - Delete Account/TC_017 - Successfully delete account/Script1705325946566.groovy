...
WebUI.check(findTestObject('05 - Delete Account/05-TC_017-success_Account_Delete/Page_OrangeHRM/button_Enabled_oxd-icon-button oxd-table-cell-action-space', 
        [('employeeName') : GlobalVariable.employeeName]))

WebUI.click(findTestObject('05 - Delete Account/05-TC_017-success_Account_Delete/Page_OrangeHRM/button_Yes, Delete'))
