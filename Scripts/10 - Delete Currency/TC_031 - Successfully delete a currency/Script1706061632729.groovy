...
WebUI.click(findTestObject('10 -Delete Currency/10-TC_031_delete_Currency/Page_OrangeHRM/button_delete_Malaysian Ringgit', 
        [('addCurrency') : addCurrency]))

WebUI.click(findTestObject('10 -Delete Currency/10-TC_031_delete_Currency/Page_OrangeHRM/button_Yes, Delete'))

WebUI.verifyElementPresent(findTestObject('10 -Delete Currency/10-TC_031_delete_Currency/Page_OrangeHRM/verify_Success'), 
    0)
