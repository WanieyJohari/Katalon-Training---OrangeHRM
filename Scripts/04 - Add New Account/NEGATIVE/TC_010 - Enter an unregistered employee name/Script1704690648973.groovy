...
WebUI.setText(findTestObject('04 - Add Account/04-TC_010-enter_Unregistered_employee/Page_OrangeHRM/input'), 'Waniey')

WebUI.verifyElementPresent(findTestObject('04 - Add Account/04-TC_010-enter_Unregistered_employee/Page_OrangeHRM/div_No Records Found'), 
    5)
