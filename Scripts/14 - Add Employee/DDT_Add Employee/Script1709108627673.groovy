...
WebUI.setText(findTestObject('14 - Add Employee/14-TC_041-success_Add_Employee/Page_OrangeHRM/input_Employee Full Name_firstName'), 
    employeeFirstName)

WebUI.setText(findTestObject('14 - Add Employee/14-TC_041-success_Add_Employee/Page_OrangeHRM/input_Employee Full Name_lastName'), 
    employeeLastName)
...
WebUI.click(findTestObject('14 - Add Employee/14-TC_041-success_Add_Employee/Page_OrangeHRM/button_Save'))

WebUI.verifyElementPresent(findTestObject('14 - Add Employee/14-TC_041-success_Add_Employee/Page_OrangeHRM/verify_Successfully Saved'), 
    0)
