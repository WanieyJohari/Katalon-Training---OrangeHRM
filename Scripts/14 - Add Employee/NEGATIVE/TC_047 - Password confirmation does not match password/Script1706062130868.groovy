...
WebUI.setText(findTestObject('14 - Add Employee/14_TC_044-enter_Registered_Username/Page_OrangeHRM/Page_OrangeHRM/input_Password_oxd-input oxd-input--focus'), 
    passwordAddEmployee)

WebUI.setText(findTestObject('14 - Add Employee/14_TC_044-enter_Registered_Username/Page_OrangeHRM/Page_OrangeHRM/Page_OrangeHRM/input_Confirm Password_oxd-input oxd-input--focus'), 
    confirmPasswordEmployee)

WebUI.verifyElementPresent(findTestObject('14 - Add Employee/14_TC_044-enter_Registered_Username/Page_OrangeHRM/Page_OrangeHRM/Page_OrangeHRM/verify_Passwords do not match'), 
    0)
