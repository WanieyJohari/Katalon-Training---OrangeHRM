...
WebUI.click(findTestObject('13 - Delete Job Category/13-TC_039-delete_Job_Category/Page_OrangeHRM/button_Engineering_oxd-icon-button oxd-table-cell-action-space', 
        [('jobCategory') : GlobalVariable.jobCategory]))

WebUI.click(findTestObject('13 - Delete Job Category/13-TC_039-delete_Job_Category/Page_OrangeHRM/button_Yes, Delete'))
